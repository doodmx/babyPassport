<footer class="container-fluid px-4 pt-4 pb-2 btn-ce-soir lighten-5 shadow">
    <div class="row flex-column flex-lg-row px-0 px-lg-5">
        ...
        <div class="col text-center text-lg-left mt-lg-4 pb-2 pb-lg-5">
            ...
            <a  href="{{route('web.index')}}" class="  text-white lead d-block py-3">
                Inicio
            </a>

            <a href="{{route('web.getAtentionCenter')}}" class="text-white lead d-block pb-4">
                Centros de atención
            </a>

            <a href="{{route('web.getBlog')}}" class="text-white lead d-block pb-4">
                Blog
            </a>

            <a href="{{route('web.getFaqs')}}" class="text-white lead d-block pb-4">
        ...
        <div class="mx-auto">
            <a href="https://medicaltourismmx.com/">
            <img class="mt-4 mb-3 text-center" src="{{asset("img/logos/MM1-blanco.png")}}" alt="logo-medical-meeting" height="70">
        </a>
        </div>
            <a href="{{route('web.getTerms')}}" class="text-white text-center py-4 d-block">
                        
                Términos y condiciones
           
             </a>
             <a href="{{route('web.getPolicies')}}" class="text-white  text-center pb-4 d-block">
        ...
        <div class="col border-left mt-lg-4 text-center text-lg-left pl-lg-5 ml-lg-5">
            ...
            <a href="tel:+4421127793" class="btn-call text-white  d-block">
               
                     <i class="fa fa-phone"></i> (442) 112 7793
