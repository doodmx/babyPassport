...
@section('content')
    ...
    <div class="mx-3 mx-lg-5 px-lg-5 my-4 my-lg-3 py-lg-5">
        <h2 class="text-grey-suit lead text-justify">Conoce nuestros paquetes de maternidad en Estados Unidos y viaja con nosotros de forma legal y segura con los mejores doctores en el extranjero o si estas buscando a los mejores doctores de México podemos apoyarte.</h2>
    </div>

    <h2 class="text-ce-soir text-center mt-5">Elige tu lugar de preferencia</h2>
