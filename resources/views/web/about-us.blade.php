...
@section('title')
    <title>Descubre Cómo Tener Más Pacientes | Ginecólogos</title>
@endsection
@section('content')
    ...
    <section class="why-join-us container">
        <div class="row">
            <div class="col-12 col-lg-12 mt-5 mb-3 px-5">
                ...
                <span class="justify-copy">
                    Por dos simples razones, la principal es porque ganarás una comisión por referir pacientes que quieran tener su parto en USA. Y lo mejor de todo es que serás parte de la red con los mejores ginecólogos a nivel internacional y nacional.
...
<div class="row">
    <div class="col-12 col-lg-4 my-4">
        ...
        <div class="flip-card mx-auto">
            <div class="flip-card-inner border-card">
              <div class="flip-card-front bg-spray border-card" style="padding-top:8rem">

                <h2 class="h3-responsive text-white">¡Conocenos!</h2>
                
              </div>
              <div class="flip-card-back bg-spray border-card" style="padding-top:6rem">
...
<div class=" col-12 col-lg-4 my-4">
   ...
   <div class="flip-card mx-auto">
       <div class="flip-card-inner border-card">
         <div class="flip-card-front bg-mandys-pink border-card">
            <h2 class="h3-responsive text-white" style="padding-top:8rem"> Recibe tu comisión </h2>
         
         </div>
         <div class="flip-card-back  bg-mandys-pink border-card" style="padding-top:6rem">
    ...
    <div class="about-cta-container pt-5 mt-lg-5">
        ...
        <div class="row flex-column-reverse flex-lg-row align-items-center">
            ...
            <div class="col-12 col-lg-7 mt-3 mt-lg-0 text-center">
                ...
                <button class=" font-campton button-border btn ml-lg-5 btn-whats-doctor-aliado btn-lg btn-ce-soir white-text font-medium waves-effect waves-light">¡Comenzar ahora!</button>
            </div>
