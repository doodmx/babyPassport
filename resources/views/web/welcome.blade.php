...
@section('content')
 ...
 <!-- SLIDER CONTAINER-->
    <section class="main-carousel owl-carousel owl-theme">
        ...
        <!-- SLIDER 2 -->
        <div class="row  mt-lg-0 mx-0 align-items-center view slider bg2 margin-slider">
   ...
   <!-- END SLIDER CONTAINER -->
    ...
    <section class="my-5 container text-center">
        ...
        <h3 class="h3-responsive text-ce-soir mb-3">
            Conecta con Baby Passport, obtén tu guía gratuita sobre como dar a luz en Estados Unidos o conoce como puedes pagar tu parto en Estados Unidos y obtén tu plan de pagos.
        </h3>

        <button class="btn btn-warning white-text btn-lg font-campton font-weight-bold btn-whats-price button-border">
            Consulta tu plan de pagos
        </button>

    <a href="https://turismomaternidad.com/guiapartoenusa" class="btn btn-warning white-text btn-lg font-campton font-weight-bold button-border">
            Guía de información
        </a>
    ...
    <!-- END CTA SECTION -->
     ...
     <section class="cities container-fluid pt-4">
        ...
        <h2 class="h2-responsive text-ce-soir text-center mb-1">BLOG PARA TI</h2>
        <div class="section-divider bg-mandys-pink my-3"></div>
